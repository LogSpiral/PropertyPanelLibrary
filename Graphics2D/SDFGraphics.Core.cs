...
public static partial class SDFGraphics
{
    ...
    private static void Round(float size)
    {
    ...
    private static void RoundBase(Vector2 pos, Vector2 percentOrigin, float size, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        Round(size);
        const float innerShrinkage = 1;
    ...
    #endregion 圆Circle/Round

    #region 曲边矩形RoundedBox

    private static void RoundedBox(Vector2 size, Vector4 round)
    {
    ...
    private static void RoundedBoxBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, Vector4 round, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 曲边矩形RoundedBox

    #region 矩形Box

    private static void Box(Vector2 size)
    {
        SDF_Effect.Parameters["uSizeOver2"].SetValue(size / 2f);
    }

    private static void BoxBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        Box(size);
        ApplyPass(passName);
    ...
    private static void OrientedBox(Vector2 start, Vector2 end, float width, Matrix matrix, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void OrientedBoxBase(Vector2 start, Vector2 end, float width, Matrix matrix, string passName)
    {
    ...
    #endregion 正交矩形OrientedBox

    #region 线段Segment/Line

    private static void Line(Vector2 start, Vector2 end, float width, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void LineBase(Vector2 start, Vector2 end, float width, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 线段Segment/Line

    #region 菱形Rhombus

    private static void Rhombus(Vector2 size)
    {
        SDF_Effect.Parameters["uSizeOver2"].SetValue(size * .5f);
    }

    private static void RhombusBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        Rhombus(size);
        ApplyPass(passName);
    ...
    private static void Trapezoid(Vector2 size, float bottomScaler)
    {
        Effect effect = SDF_Effect;
    ...
    private static void TrapezoidBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, float bottomScaler, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 梯形Trapezoid

    #region 平行四边形Parallelogram

    private static void Parallelogram(Vector2 size, float bottomScaler)
    {
        Effect effect = SDF_Effect;
        effect.Parameters["uBottomScaler"].SetValue(bottomScaler);
        effect.Parameters["uSizeOver2"].SetValue(size * .5f);
    ...
    private static void ParallelogramBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, float bottomScaler, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 平行四边形Parallelogram

    #region 等边三角形EquilateralTriangle

    private static void EquilateralTriangle(float r, out Vector2 size)
    {
    ...
    private static void EquilateralTriangleBase(Vector2 pos, Vector2 percentOrigin, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 等边三角形EquilateralTriangle

    #region 等腰三角形TriangleIsosceles

    private static void TriangleIsosceles(Vector2 size)
    {
        SDF_Effect.Parameters["uSizeOver2"].SetValue(size * .5f);
    }

    private static void TriangleIsoscelesBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 等腰三角形TriangleIsosceles

    #region 三角形Triangle

    private static void Triangle(Vector2 A, Vector2 B, Vector2 C, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void TriangleBase(Vector2 A, Vector2 B, Vector2 C, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 三角形Triangle

    #region 胶囊UnevenCapsule

    private static void UnevenCapsule(float distance, float round1, float round2, out Vector2 size)
    {
    ...
    private static void UnevenCapsuleBase(Vector2 pos, Vector2 percentOrigin, float distance, float round1, float round2, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 胶囊UnevenCapsule

    #region 正五边形Pentagon

    private static void Pentagon(float r, out Vector2 size)
    {
    ...
    private static void PentagonBase(Vector2 pos, Vector2 percentOrigin, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 正五边形Pentagon

    #region 正六边形Hexagon

    private static void Hexagon(float r, out Vector2 size)
    {
    ...
    private static void HexagonBase(Vector2 pos, Vector2 percentOrigin, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 正六边形Hexagon

    #region 正八边形Octogon

    private static void Octogon(float r, out Vector2 size)
    {
        size = new Vector2(r);
        SDF_Effect.Parameters["uSizeOver2"].SetValue(size);
        size *= 2;
    ...
    private static void OctogonBase(Vector2 pos, Vector2 percentOrigin, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 正八边形Octogon

    #region 正N边形Ngon

    private static void Ngon(float r, float N, out Vector2 size)
    {
        Effect effect = SDF_Effect;
    ...
    private static void NgonBase(Vector2 pos, Vector2 percentOrigin, float r, float N, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Hexagram(float r, out Vector2 size)
    {
        size = new Vector2(1.73205f, 2) * r;
        SDF_Effect.Parameters["uSizeOver2"].SetValue(size * .5f);
    }

    private static void HexagramBase(Vector2 pos, Vector2 percentOrigin, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 六芒星Hexagram

    #region 五角星Star5

    private static void Star5(float r, float rf, out Vector2 size)
    {
        Effect effect = SDF_Effect;
        const float c = 0.80902f; // cos(pi / 5)
    ...
    private static void Star5Base(Vector2 pos, Vector2 percentOrigin, float r, float rf, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void StarX(float r, float N, float k, out Vector2 size)
    {
        Effect effect = SDF_Effect;
        float angle = MathHelper.Pi / N;
        float l = r / MathF.Cos(angle);
    ...
    private static void StarXBase(Vector2 pos, Vector2 percentOrigin, float r, float N, float k, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Pie(float r, float angle, out Vector2 size)
    {
    ...
    private static void PieBase(Vector2 pos, Vector2 percentOrigin, float r, float angle, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void CutDisk(float r, float k, out Vector2 size)
    {
    ...
    private static void CutDiskBase(Vector2 pos, Vector2 percentOrigin, float r, float k, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Arc(float r, float angle, float width, out Vector2 size)
    {
        float s = MathF.Sin(angle);
        float c = MathF.Cos(angle);
    ...
    private static void ArcBase(Vector2 pos, Vector2 percentOrigin, float r, float angle, float width, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Ring(float r, float angle, float width, out Vector2 size)
    {
        float s = MathF.Sin(angle);
        float c = MathF.Cos(angle);
    ...
    private static void RingBase(Vector2 pos, Vector2 percentOrigin, float r, float angle, float width, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Horseshoe(float r, float angle, float width, float length, out Vector2 size)
    {
        float s = MathF.Sin(angle);
        float c = MathF.Cos(angle);
    ...
    private static void HorseshoeBase(Vector2 pos, Vector2 percentOrigin, float r, float angle, float width, float length, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 马蹄铁Horseshoe

    #region 鱼鳔Vesica

    private static void Vesica(float r, float distance, out Vector2 size)
    {
    ...
    private static void VesicaBase(Vector2 pos, Vector2 percentOrigin, float r, float distance, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void OrientedVesica(Vector2 pos1, Vector2 pos2, float r, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void OrientedVesicaBase(Vector2 pos1, Vector2 pos2, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 正交鱼鳔OrientedVesica

    #region 月Moon

    private static void Moon(float r1, float r2, float x, out Vector2 size)
    {
    ...
    private static void MoonBase(Vector2 pos, Vector2 percentOrigin, float r1, float r2, float x, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void CircleCross(Vector2 baseSize, float r, out Vector2 size)
    {
    ...
    private static void CircleCrossBase(Vector2 pos, Vector2 percentOrigin, Vector2 baseSize, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 曲边四芒星CircleCross

    #region 蛋Egg

    private static void Egg(float ra, float rb, float height, out Vector2 size)
    {
    ...
    private static void EggBase(Vector2 pos, Vector2 percentOrigin, float ra, float rb, float height, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Heart(float sizeX, out Vector2 size)
    {
    ...
    private static void HeartBase(Vector2 pos, Vector2 percentOrigin, float sizeX, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Plus(float d, float c, float r, out Vector2 size)
    {
    ...
    private static void PlusBase(Vector2 pos, Vector2 percentOrigin, float d, float c, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 十字Cross/Plus

    #region 叉号RoundedX/Cross

    private static void Cross(float width, float round, out Vector2 size)
    {
        const float innerShrinkage = 1;
    ...
    private static void CrossBase(Vector2 pos, Vector2 percentOrigin, float width, float round, Matrix matrix, string passName)
    {
        width *= .5f;
        SetCommon(matrix);
    ...
    #endregion 叉号RoundedX/Cross

    #region 多边形Polygon

    private static void Polygon(Vector2[] vecs, Matrix matrix, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void PolygonBase(IEnumerable<Vector2> vecs, Matrix matrix, string passName)
    {
    ...
    #endregion 多边形Polygon

    #region 椭圆Ellipse

    private static void Ellipse(Vector2 r)
    {
        SDF_Effect.Parameters["uSizeOver2"].SetValue(r);
    }

    private static void EllipseBase(Vector2 pos, Vector2 percentOrigin, Vector2 r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        Ellipse(r);
        ApplyPass(passName);
    ...
    private static void Parabola(Vector2 size)
    {
        Effect effect = SDF_Effect;
    ...
    private static void ParabolaBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        Parabola(size);
        ApplyPass(passName);
    ...
    #endregion 抛物线Parabola

    #region 抛物线段ParabolaSegment

    private static void ParabolaSegment(Vector2 size, float height)
    {
        Effect effect = SDF_Effect;
    ...
    private static void ParabolaSegmentBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, float height, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 抛物线段ParabolaSegment

    #region 二阶贝塞尔曲线QuadraticBezier

    private static void QuadraticBezier(Vector2 start, Vector2 control, Vector2 end, float width, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void QuadraticBezierBase(Vector2 start, Vector2 control, Vector2 end, float width, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 二阶贝塞尔曲线QuadraticBezier

    #region 圆头十字BlobbyCross

    private static void BlobbyCross(float s, float k, float r, out Vector2 size)
    {
    ...
    private static void BlobbyCrossBase(Vector2 pos, Vector2 percentOrigin, float s, float k, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 圆头十字BlobbyCross

    #region 隧道Tunnel

    private static void Tunnel(Vector2 wh, out Vector2 size)
    {
        SDF_Effect.Parameters["uSizeOver2"].SetValue(wh);
        size = new Vector2(2 * wh.X, wh.X + wh.Y);
    }

    private static void TunnelBase(Vector2 pos, Vector2 percentOrigin, Vector2 wh, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void Stairs(Vector2 unit, float count, out Vector2 size)
    {
        size = unit * count;
        Effect effect = SDF_Effect;
    ...
    private static void StairsBase(Vector2 pos, Vector2 percentOrigin, Vector2 unit, float count, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    private static void QuadraticCircle(float r)
    {
        SDF_Effect.Parameters["uSizeOver2"].SetValue(new Vector2(r));
    }

    private static void QuadraticCircleBase(Vector2 pos, Vector2 percentOrigin, float r, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        QuadraticCircle(r);
        ApplyPass(passName);
    ...
    #endregion 四次方圆QuadraticCircle

    #region 双曲线Hyperbola

    private static void Hyperbola(Vector2 size)
    {
    ...
    private static void HyperbolaBase(Vector2 pos, Vector2 percentOrigin, Vector2 size, Matrix matrix, string passName)
    {
        SetCommon(matrix);
        Hyperbola(size);
        ApplyPass(passName);
    ...
    #endregion 双曲线Hyperbola

    #region 酷酷S CoolS

    private static void CoolS(float height, Matrix matrix)
    {
        Effect effect = SDF_Effect;
    ...
    private static void CoolSBase(Vector2 pos, Vector2 percentOrigin, float height, Matrix matrix, string passName)
    {
        CoolS(height, matrix);
        ApplyPass(passName);
    ...
    private static void CircleWave(float width, float k, float r, float lineWidth, out Vector2 size)
    {
    ...
    private static void CircleWaveBase(Vector2 pos, Vector2 percentOrigin, float width, float k, float r, float lineWidth, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 圆波CircleWave

    #region 连段二阶贝塞尔曲线ChainedQuadraticBezier

    private static void ChainedQuadraticBezier(Vector2[] vecs, out Vector2 pos, out Vector2 size)
    {
    ...
    private static void ChainedQuadraticBezierBase(IEnumerable<Vector2> vecs, Matrix matrix, string passName)
    {
        SetCommon(matrix);
    ...
    #endregion 连段二阶贝塞尔曲线ChainedQuadraticBezier
}